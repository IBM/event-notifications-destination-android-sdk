...
# Android destination SDK for IBM Cloud Event Notifications service Version 0.1.0
...
--- | ---
[Event Notifications Service](https://cloud.ibm.com/apidocs/event-notifications) | com.ibm.cloud:eventnotifications-destination-android:0.1.0
...
### Gradle
```gradle
compile 'com.ibm.cloud:eventnotifications-destination-android:0.1.0'
```
...
2. Add SDK dependency to your Module level `build.gradle` file.
	...
	dependencies {
        ...
        implementation 'com.ibm.cloud:eventnotifications-destination-android:0.1.0'
        .......
	}
	```
